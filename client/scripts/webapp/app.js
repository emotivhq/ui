...
angular.module('GiftStarterApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/scripts/static-pages/about/about.html',
    ...
    "\t  <div class=\"font ui class container vertical top medium  middle aligned center grid centered\">\n" +
    "\t\t  <div class=\"ui items divided\">\n" +
    "\t\t\t  \n" +
    "\t\t  \n" +
    "    <p class=\"item\">\n" +
    "\t\tTo enable people to make meaningful connections with others using the power of gifts.</p>\n" +
    "      <ul class=\"ui item items\">\n" +
    "\t  \t<li class=\"item\" style=\"margin-top: 1em;\">Want to send a gift to someone?</li>\n" +
  ...
  $templateCache.put('/scripts/static-pages/faq/faq.html',
    ...
    "            <h3>We are here to help in any way we can. Start here if you have questions.</h3>\n" +
    "            <a ng-click=\"toggleAll()\" class=\"ui labeled icon button white huge\">\n" +
    "                <div class=\"ui visible content\">\n" +
    "                    <span ng-hide=\"openQuestions.length == questionCount\">Expand All</span>\n" +
    "                    <span ng-show=\"openQuestions.length == questionCount\">Close All</span>\n" +
    "                </div>\n" +
    "                <i class=\"plus icon left\" ng-hide=\"openQuestions.length == questionCount\"></i>\n" +
    "                <i class=\"minus icon left\" ng-show=\"openQuestions.length == questionCount\"></i>\n" +
    "\t\t\t\t<div class=\"ui hidden content\">Super Fun!</div>\n" +
    "            </a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <div class=\"main\">\n" +
  ...
  $templateCache.put('/scripts/static-pages/press/press.html',
    ...
    "\t  <div class=\"ui container\">\n" +
    "    <h1>In The News</h1>\n" +
    "    <h4>We've been fortunate enough to be featured by some great media outlets across the globe. </h4>\n" +
    "\t\t  <a href=\"/join\" class=\"ui right labeled icon button huge\" >\n" +
    ...
    "\t  </h3>\n" +
    "<div class=\"ui items link container column stackable three \">\n" +
    "  <a href=\"{{item.link}}\" target=\"_blank\" class=\"press-item item column\" ng-repeat=\"item in items\">\n" +
    "    <div class=\"ui large image\">\n" +
    "      <img src=\"assets/press/{{item.img}}\" style=\"max-height: 35px;\" />\n" +
    "    </div>\n" +
    "    <div class=\"content\">\n" +
    "      <div class=\"header\"></div>\n" +
    "      <div class=\"description\">\n" +
    "        <em ng-bind-html=\"item.quote\"></em>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </a>\n" +
    "\t  </div>\n" +
